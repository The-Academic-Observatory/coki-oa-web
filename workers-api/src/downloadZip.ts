...
This zip package contains only a subset of aggregated data from the COKI Open Access Dataset for ${entity.name} in CSV format, between the years of ${entity.start_year} and ${entity.end_year}. \n \
\n \
## Licence \n \
[COKI Open Access Dataset](https://open.coki.ac/data/) © 2022 by [Curtin University](https://www.curtin.edu.au/) \n \
